...
class Generator(nn.Module):
    def __init__(self, args):
        ...
        self.l1 = nn.Linear(128, (self.bottom_width ** 2) * args.gf_dim)
    ...
    def forward(self, z, labels):
        ...
        h = self.l1(x).view(-1, self.ch, self.bottom_width, self.bottom_width)
...
class Discriminator(nn.Module):
    ...
    def forward(self, x, labels):
        #h = torch.cat((x, (labels.type(torch.cuda.FloatTensor))), 1)
        h = x
        bs = h.shape[0]
